...
@Component({
  selector: 'ngx-flame8',
  styleUrls: ['./flame8.component.scss'],
  templateUrl: './flame8.component.html',
})
export class Flame8Component {

  tabs: any[] = [
    {
      title: 'Route tab #1',
      route: '/pages/codebase/flame8/tab1',
    },
    {
      title: 'Route tab #2',
      route: '/pages/codebase/flame8/tab2',
    },
  ];
