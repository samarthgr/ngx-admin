...
@Component({
  selector: 'ngx-flame7',
  styleUrls: ['./flame7.component.scss'],
  templateUrl: './flame7.component.html',
})
export class Flame7Component {

  tabs: any[] = [
    {
      title: 'Route tab #1',
      route: '/pages/codebase/flame7/tab1',
    },
    {
      title: 'Route tab #2',
      route: '/pages/codebase/flame7/tab2',
    },
  ];
